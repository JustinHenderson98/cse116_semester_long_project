...
public class escapetimeTests {	
	...
	public void pixelToCoordinateXTest1(){
		...
		double output = pixelToCoordinateXTest1.pixelRowToCoordinate(xRangeStart, xSpace, 512);
		assertEquals(-2.15, output, 0.00001);
		int output2 = pixelToCoordinateXTest1.pixelRowToCoordinate(xRangeStart, xSpace, 512);
		assertEquals(0.6, output2, 0.00001);
		int output3 = pixelToCoordinateXTest1.pixelRowToCoordinate(xRangeStart, xSpace, 512);
	...
	public void pixelToCoordinateXTest2(){
		...
		double output = pixelToCoordinateXTest2.pixelRowToCoordinate(xRangeStart, xSpace, 512);
		assertEquals(-1.7, output, 0.00001);
		int output2 = pixelToCoordinateXTest2.pixelRowToCoordinate(xRangeStart, xSpace, 512);
		assertEquals(1.7, output2, 0.00001);
		int output3 = pixelToCoordinateXTest2.pixelRowToCoordinate(xRangeStart, xSpace, 512);
	...
	public void pixelToCoordinateXTest3(){
		...
		double output = pixelToCoordinateXTest3.pixelRowToCoordinate(xRangeStart, xSpace, 512);
		assertEquals(-1.8, output, 0.00001);
		int output2 = pixelToCoordinateXTest3.pixelRowToCoordinate(xRangeStart, xSpace, 512);
		assertEquals(-1.7, output2, 0.00001);
		int output3 = pixelToCoordinateXTest3.pixelRowToCoordinate(xRangeStart, xSpace, 512);
		assertEquals(, output3, 0.00001);
	}
	...
	public void pixelToCoordinateXTest4(){
		...
		double output = pixelToCoordinateXTest4.pixelRowToCoordinate(xRangeStart, xSpace, 512);
		assertEquals(-1.0, output, 0.00001);
		int output2 = pixelToCoordinateXTest4.pixelRowToCoordinate(xRangeStart, xSpace, 512);
		assertEquals(1.0, output2, 0.00001);
		int output3 = pixelToCoordinateXTest4.pixelRowToCoordinate(xRangeStart, xSpace, 512);
		assertEquals(, output3, 0.00001);
	}
	...
	public void pixelToCoordinateYTest1(){
		...
		double output = pixelToCoordinateYTest1.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(-1.3, output, 0.0001);
		double output2 = pixelToCoordinateYTest1.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(1.3, output, 0.0001);
		double output3 = pixelToCoordinateYTest1.pixelColToCoordinate(yRangeStart, ySpace, 512);
	...
	public void pixelToCoordinateYTest2(){
		...
		double output = pixelToCoordinateYTest2.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(-1.0, output, 0.0001);
		double output2 = pixelToCoordinateYTest2.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(1.0, output, 0.0001);
		double output3 = pixelToCoordinateYTest2.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(, output, 0.0001);
	}
	...
	public void pixelToCoordinateYTest3(){
		...
		double output = pixelToCoordinateYTest3.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(-0.08, output, 0.0001);
		double output2 = pixelToCoordinateYTest3.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(-0.025, output, 0.0001);
		double output3 = pixelToCoordinateYTest3.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(, output, 0.0001);
	}
	...
	public void pixelToCoordinateYTest4(){
		...
		double output = pixelToCoordinateYTest4.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(-1.3, output, 0.0001);
		double output2 = pixelToCoordinateYTest4.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(1.3, output, 0.0001);
		double output3 = pixelToCoordinateYTest4.pixelColToCoordinate(yRangeStart, ySpace, 512);
		assertEquals(, output, 0.0001);
	}
}